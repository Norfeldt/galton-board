  ...
  return (
    <div className={`text-center mx-auto w-full py-12 ${className}`}>
      <div className="relative inline-block">
        <h1
          className="text-5xl sm:text-7xl lg:text-8xl font-black uppercase tracking-widest relative z-10"
          style={{
        ...
        <h1
          className="text-5xl sm:text-7xl lg:text-8xl font-black uppercase tracking-widest absolute inset-0 z-0"
          style={{
            color: '#00f0ff',
