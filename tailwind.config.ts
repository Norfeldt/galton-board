  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        ...
        sans: ['JetBrains Mono', 'monospace'], // Override default sans with mono
      },
      colors: {
      ...
      textShadow: {
        ...
        'glow-blue-sm': '0 0 5px #00f0ff, 0 0 10px #00f0ff, 0 0 15px #00f0ff',
        'glow-blue-lg': '0 0 15px #00f0ff, 0 0 30px #00f0ff, 0 0 45px #00f0ff',
      },
    },
  },
